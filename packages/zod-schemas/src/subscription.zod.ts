...
import { zSmallint, zString, zTimeEpoch, zTimestampsAsNumbers } from "./zod_utils.js";
...
export const subscriptionUpdateInputZod = subscriptionMandatoryZod.extend(subscriptionOptionalZod.shape).extend(zTimestampsAsNumbers).partial();
export type SubscriptionUpdateInput = z.infer<typeof subscriptionUpdateInputZod>;

export const subscriptionSelectAllZod = subscriptionMandatoryZod.extend(subscriptionOptionalZod.shape).extend(subscriptionAutoGeneratedZod.shape).extend(zTimestampsAsNumbers);
