...
import { zSmallint, zString, zTimestampsAsNumbers } from "./zod_utils.js";
...
export const apiProductRequestLogUpdateInputZod = apiProductRequestLogMandatoryZod.extend(apiProductRequestOptionalZod.shape).extend(zTimestampsAsNumbers).partial();
export type ApiProductRequestLogUpdateInput = z.infer<typeof apiProductRequestLogUpdateInputZod>;

export const apiProductRequestLogSelectAllZod = apiProductRequestLogMandatoryZod.extend(apiProductRequestOptionalZod.shape).extend(zTimestampsAsNumbers).extend(apiProductRequestLogAutoGeneratedZod.shape);
